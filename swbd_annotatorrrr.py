input_dir = "/home/naime/Desktop/paria/2_end-to-end-20210216T012208Z-001/2_end-to-end/FISHER/switchboard_word_alignments/swb_ms98_transcriptions"
    ...
    *_parse.txt and *_dys.txt files, respectively.
    ...
    def setup(self): 
        all_2004 = self.parse_sentences(            
            trans_data=os.path.join("swb_ms98_transcriptions", "swb_ms98_transcriptions"),
            parsed_data="swb-annotations"
        )
